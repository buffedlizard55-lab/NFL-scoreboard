...
(function (root, factory) {
  ...
  const BOOTH_AT_RISK_LOOKBACK = 3; // plays after a score in which a booth event can still wipe it
  ...
  function boothPointsAtRisk(event, plays, index, effect) {
    ...
    const scoring = nearestScoringPlay(plays, index, BOOTH_AT_RISK_LOOKBACK);
