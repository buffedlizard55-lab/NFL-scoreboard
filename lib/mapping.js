...
(function (root, factory) {
   ...
   * be the ruling that removed it. If a live response carries a stale 0-0
   * score on the kickoff after a touchdown, a return-team penalty on that
   * kickoff is not a ruling on the touchdown, so treating the temporary
