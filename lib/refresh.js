 ...
 * live-header score/status feed has a separate fast schedule (150 ms), while
 * each live game's full detail (including the play descriptions used for
 * scoring-ruling context) runs every second. Neither waits for the selected-
...
(function (root, factory) {
  ...
  // this is an attempted cadence, not a freshness guarantee. It is kept fast to
  // surface a new scoring review/penalty as early as the provider publishes it.
  const LIVE_SCORES_INTERVAL_MS = 150;
